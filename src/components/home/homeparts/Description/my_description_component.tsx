...
function My_Description() {
  ...
  <p>Construyo apps web con <span className="underline_blue">React</span>, <span className="underline_red">Angular</span> & <span className="underline_darkblue">WordPress</span>.
  <br/><br/>
